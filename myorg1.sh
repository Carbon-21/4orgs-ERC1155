...
function setenvs() {
    ...
    export TARGET_TLS_OPTIONS=(-o orderer.example.com:7050 --ordererTLSHostnameOverride orderer.example.com --tls --cafile $ORDERER_CA --peerAddresses localhost:7051 --tlsRootCertFiles "$PEER0_ORG1_CA" --peerAddresses localhost:8051 --tlsRootCertFiles "$PEER0_ORG2_CA" --peerAddresses localhost:9051 --tlsRootCertFiles "$PEER0_ORG3_CA" --peerAddresses localhost:10051 --tlsRootCertFiles "$PEER0_ORG4_CA")
