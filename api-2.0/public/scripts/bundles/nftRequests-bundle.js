    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          url = "https://localhost:4000/nft/requests?requestStatus=".concat(status);
          init = {
            method: "GET",
            headers: headers
          };
...
window.requests = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
  var status, search, _yield$getRequests, requestsList, element, requestsFiltered;
    ...
    while (1) switch (_context2.prev = _context2.next) {
      ...
      case 5:
        ...
        if (requestsFiltered.length === 0) {
          element += "<div class=\"d-flex flex-column justify-content-between p-md-1\">\n                    <center><h2><font color=\"#5f5f5f\">Sem solicita\xE7\xF5es no momento </font></h2> </center>\n                </div>";
          document.getElementById("requests-show").innerHTML = element;
        } else {
          requestsFiltered.map(function (req) {
            element += "<a class=\"request-data\" href=\"/nft/mint?requestId=".concat(req.id, "\">\n                        <div class=\"info-data\">\n                            <p><b>Dono da terra: </b> ").concat(req.landOwner, "</p>\n                        </div>\n                        <div class=\"info-data\">\n                            <p><b>Fitofisiologia: </b> ").concat(req.phyto, "</p>\n                            <div class=\"info-data\">\n                                <p><b>\xC1rea da terra: </b> ").concat(req.landArea, " hectares</p>\n                            </div>\n                        </div>\n                    </a>");
          });
